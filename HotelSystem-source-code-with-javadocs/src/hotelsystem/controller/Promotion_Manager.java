...
public class Promotion_Manager extends Database_Manager{
	private static final String DB_PATH = "DB/Promo.dat";
	private static Promotion_Manager instance = null;
	...
	public static Promotion_Manager getInstance() {
		if (instance == null) {
			instance = new Promotion_Manager();
		}
		return instance;
	}
