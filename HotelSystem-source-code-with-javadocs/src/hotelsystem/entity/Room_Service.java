...
public class Room_Service implements Serializable{
	...
	public Room_Service(ArrayList<Food> foodList, int roomStatusID, String desc, double totalPrice, String status) {
	...
	public static int getIncID() { return Room_Service.incID;}
	
	public static void setIncID(int ID) { Room_Service.incID = ID; }
