...
public class Room_Status implements Serializable{
	...
	public Room_Status(int roomBookings_ID,String roomFloor_No,int guest_ID ,String status, Date date_from, Date date_to) {
		super();
	...
	public Room_Status(String roomFloor_No,int guest_ID, String status, Date date_from, Date date_to) {
		super();
	...
	public static void setIncID(int incID) { Room_Status.incID = incID; }
